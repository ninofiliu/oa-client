...
describe('validateRequest', () => {
    it('throws for invalid path params', () => {
        ...
        expect(() => validateRequest(validationLevel, routeSpecs, pathParams, queryParams, body, contentType)).toThrow('[oa-client:103]');
    });
    ...
    it('does not throw for valid all', () => {
        ...
        const body = 40;
        const contentType = 'application/json';
        expect(() => validateRequest(validationLevel, routeSpecs, pathParams, queryParams, body, contentType)).not.toThrow();
    });
});
